part of groupssettings_v1_api_console;

/** Client to access the groupssettings v1 API */
/** Lets you manage permission levels and related settings of a group. */
class Groupssettings extends ConsoleClient {
  ...
  Groupssettings([oauth2.OAuth2Console auth]) : super(auth) {
